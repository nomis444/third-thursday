...
INSERT INTO events (event_date, venue_name, venue_address) VALUES
  ('2026-06-18', 'Santora''s Pizza Pub & Grill', 'Transit Rd, Williamsville'),
  ('2026-07-16', 'Brite Smith Brewery', 'Main St, Williamsville'),
  ('2026-08-20', 'Brite Smith Brewery', 'Main St, Williamsville');
